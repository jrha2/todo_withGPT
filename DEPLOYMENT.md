# 투자기획팀 업무관리 공간 1.5.3 배포 및 운영 안내
...
```text
apps\desktop\release\투자기획팀 업무관리 공간-설치파일-1.5.3.exe
apps\desktop\release\투자기획팀 업무관리 공간-설치파일-1.5.3.exe.sha256.txt
apps\desktop\release\투자기획팀 업무관리 공간-1.5.3-win-x64.zip
apps\desktop\release\투자기획팀 업무관리 공간-1.5.3-win-x64.zip.sha256.txt
```
